...
### Immédiat
- [ ] **🔬 ANALYSE `max_open_positions` 5 vs 7 vs 10 (backtest, hors Opus — config/analyse)** — issue du /bilan 06-13 : le cap live (5) ne prend que ~1-2 signaux sur 13 quand des clusters H4 crypto tirent ensemble → sous-échantillonnage. Question : **cap=5 améliore-t-il réellement le risque, ou se contente-t-il de sous-échantillonner l'edge ?** Spec :
