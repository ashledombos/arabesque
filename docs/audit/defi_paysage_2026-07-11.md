...
1. **P1 — Mesurer l'écart de funding cross-DEX** (protocole à pré-enregistrer).
   ...
   trancher au protocole : historique paginable par venue (HL oui, 12 mois ;
   Lighter/Pacifica/Aster/EdgeX à vérifier — sinon collecte forward 3-4 semaines,
   collecteurs djienne réutilisables) ; univers (majors ∩ venues) ; seuil de
...
3. **P3 — Socle de trésorerie** (lending stablecoin / PT fixe) : seulement quand la
